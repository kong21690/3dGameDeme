import { _decorator, director, instantiate, LabelComponent, loader, ImageAsset, SpriteFrame, SpriteComponent } from 'cc';
    ...
    protected onCreated() {
        ...
        for (let i = 1; i < demos.length; ++i) {
            ...
            if (demo.folder && demo.icon) {
                loader.loadRes(demo.folder + '/' + demo.icon, ImageAsset, (err, imgAsset: ImageAsset) => {
                    if(imgAsset){
