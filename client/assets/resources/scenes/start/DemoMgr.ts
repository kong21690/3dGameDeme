...
export class DemoMgr {
    private static _inst: DemoMgr = null;
    ...
    constructor() {
        this._demos = [
            ...
            { title: '模型查看器\nModel Viewer', folder: 'scenes/model_viewer', scene: 'model_viewer', icon: 'preview.jpg' },
            { title: '边缘光\nRim Light', folder: 'scenes/rim_light', scene: 'rim_light', icon: 'preview.jpg' },
