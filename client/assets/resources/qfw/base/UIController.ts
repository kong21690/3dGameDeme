import { _decorator, Component, Node, Prefab, Texture2D, loader, instantiate, find, ButtonComponent, EventHandler, EventTouch, game, ToggleComponent, SliderComponent } from 'cc';
