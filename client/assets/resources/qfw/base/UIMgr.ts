import { _decorator, Component, Node, Prefab, Texture2D, loader, instantiate, find, WidgetComponent, UITransformComponent, director, game, view, ResolutionPolicy, Layers, macro } from 'cc';
